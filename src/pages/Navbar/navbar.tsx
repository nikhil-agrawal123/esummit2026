  ...
  return (
    <div ref={ref} className="navbar">
      ...
      <div className="lanterns">
        <a href="/about">
          <img className="lantern l1" src={lanterne} />
        </a>

        <a href="/events">
          <img className="lantern l2" src={lanterna} />
        </a>

        <a href="/speakers">
          <img className="lantern l3" src={lanterns1} />
        </a>

        <a href="/sponsors">
          <img className="lantern l4" src={lanterns2} />
        </a>
      </div>
    </div>
  );
